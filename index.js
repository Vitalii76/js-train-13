...
function manipulateUrl(url) {
  ...
  let url10bj = new URL(url);
  url10bj.protocol = "https";
  url10bj.host = "newhost.com";

  url10bj.searchParams.append("newParam", "newValue");
  if (url10bj.searchParams.has("oldParam")) {
    url10bj.searchParams.delete("oldParam");
  }

  return {
    href: url10bj.href,
    protocol: url10bj.protocol,
    host: url10bj.host,
    pathname: url10bj.pathname,
    search: url10bj.search,
    params: [...url10bj.searchParams.entries()],
  };
}
